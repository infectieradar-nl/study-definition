  ...
  constructor() {
    super({
      ...
      durationText: new Map([
        ...
        ["nl", "Lees meer over het zelftest-onderzoek onder Informatie. Laat eventueel hier je gegevens achter zodat we je testen kunnen toesturen, en je je uitslag kan inzien."],
      ])
    });
    ...
    return SurveyItems.consent({
      ...
      topDisplayCompoments: [
        ComponentGenerators.markdown({
          content: new Map([
            ["nl", `
Om deel te nemen aan het [zelftest-onderzoek](/about-selfteststudy) moeten we toestemming hebben om je adresgegevens te verwerken. Ook hebben we je toestemming nodig om de neus- en keelmonsters die je instuurt te testen in het laboratorium en op te slaan.
