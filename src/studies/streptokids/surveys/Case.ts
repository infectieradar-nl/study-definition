...
class CaseDef extends SurveyDefinition {
  ...
  constructor() {
    ...
    const conditionForWantToParticipate = SurveyEngine.consentQuestion.accepted(this.consent_igas.key);
      ...
      customValidations: [
        {
          ...
          rule: expWithArgs('or',
            ...
            expWithArgs('checkResponseValueWithRegex', this.key, [responseGroupKey, inputKey].join('.'), '^[A-Za-z][A-Za-z][A-Za-z][A-Za-z][0-9][0-9][0-9][0-9][0-9]$'),
          )
        }
      ],
